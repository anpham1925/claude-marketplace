...
| NestJS architecture or conventions | `nestjs-toolkit:nestjs-stack` |
| Methodology / how-to guidance | `engineering-toolkit:engineering-foundations` |

**Routing rule**: Always prefer the orchestrator. Only invoke individual stage/phase skills (e.g., `/engineering-toolkit:ship-branch`, `/engineering-toolkit:ai-dlc inception`) when the user explicitly names them. The orchestrators encode the correct ordering, conventions, and quality gates.
