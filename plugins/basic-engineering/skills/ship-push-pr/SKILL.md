---
name: ship-push-pr
description: "Internal stage of the ship-n-check pipeline — pushes branch and creates a draft PR. Invoke directly only via /basic-engineering:ship-push-pr when explicitly requested by name. For general requests like 'push' or 'create PR', use basic-engineering:ship-n-check which routes here automatically."
