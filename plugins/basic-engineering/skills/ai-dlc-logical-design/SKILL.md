...
description: "Internal phase of the ai-dlc pipeline — applies architectural patterns, maps NFRs to design decisions, generates ADRs, and produces plan summary (specs.md + flows.md). Invoke directly only via /basic-engineering:ai-dlc-logical-design when explicitly requested by name. For general requests, use basic-engineering:ai-dlc which routes here automatically."
...
**specs.md** — Consolidated specifications (same format as sdlc-design):
