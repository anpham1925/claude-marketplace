---
name: ship-staging
description: "Internal stage of the ship-n-check pipeline — verifies staging deployment with health and endpoint checks. Invoke directly only via /basic-engineering:ship-staging when explicitly requested by name. For general requests like 'check staging' or 'verify deployment', use basic-engineering:ship-n-check which routes here automatically."
